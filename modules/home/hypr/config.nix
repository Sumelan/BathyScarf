  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bind = [
        ...
        "$mainMod CTRL, E, exec, thunar"
        "$mainMod, E, exec, hyprctl dispatch exec '[float; center; size 1111 700] thunar'"
      ...
      windowrulev2 = [
        ...
        "opacity 1.0 override 1.0 override, title:^(.*swayimg.*)$"
