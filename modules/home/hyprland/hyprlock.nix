...
in
{
  ...
  xdg.configFile."hypr/hyprlock.conf".text = ''
    ...
    label {
      ...
      shadow_passes = 3
      position = 0, ${if (host == "Rei") then "-25" else "-150"}
      halign = center
      valign = top
    }
    ...
    label {
      ...
      shadow_passes = 3
      position = 0, ${if (host == "Rei") then "-225" else "-350"}
      halign = center
      valign = top
    }
    ...
    shape {
      ...
      position = 0, ${if (host == "Rei") then "120" else "270"}
      halign = center
      valign = bottom
    }
    ...
    label {
      ...
      font_size = 15
      font_family = Maple Mono Bold
      position = 0, ${if (host == "Rei") then "131" else "281"}
      halign = center
      valign = bottom
    }
    ...
    input-field {
      ...
      hide_input = false
      position = 0, ${if (host == "Rei") then "50" else "200"}
      halign = center
      valign = bottom
    }
  '';
